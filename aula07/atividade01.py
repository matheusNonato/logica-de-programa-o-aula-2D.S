'''
   Desenvolva um sistema de gerenciamento de veiculos, permita cadastrar o veiculo pegando do usuario os seguintes  (nodelo, marca, preço)

     - os dados devem ser armazenados em um arquivo.
     - o usuario deve poder cadastrar quantos carros quiser sem ter que rodar o sistema novamente.
...
while True:
    ...
    if opcao == '1':
        ...
        carros.append(carro)
        proximo_id += 1
        with open('carro.txt', 'w') as arquivo:
            for c in carros:
                arquivo.write(
